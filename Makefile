...
one_file:
	$(GNU_LINUX_COMPILER) -c src/Application/Application.cpp $(flags)
	mv *.o bin
...
win_assemble:
	$(MINGW_COMPILER) -c -static -g -Og -std=c++20 -Wa,-mbig-obj src/Components/ParticleSystem.cpp $(win_flags) -lrusty_vault
	mv *.o bin_win
